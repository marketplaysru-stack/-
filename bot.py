...
# -*- coding: utf-8 -*-
"""
Бот для родительского навигатора (с vk_api, логированием wall.post)
"""
...
def upload_photo_to_vk_via_vkapi(image_bytes, owner_id, token):
    ...
    try:
        ...
        # Определяем, для группы или публичной страницы
        ...
        else:  # публичная страница или пользователь
            photo = upload.photo_wall(temp_path, group_id=owner_id)
            logger.info(f"Загрузка в публичную страницу (group_id={owner_id})")
